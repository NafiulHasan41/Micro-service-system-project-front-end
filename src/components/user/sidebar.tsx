                    ...
                    <SidebarGroupContent>
                        <SidebarMenu>
                            ...
                            <SidebarMenuItem className="mt-2 p-2 rounded-md hover:bg-gray-200 transition"
                                key={item.title}>
                                <Link href={`/dashboard/user/${item.url}`} className="flex items-center space-x-3">
            ...
            <SidebarContent>
                <SidebarGroup>
                    ...
                    <SidebarGroupContent>
                        <SidebarMenu>
                            {account.map((item) => (
                            <SidebarMenuItem className="my-2 p-2 rounded-md hover:bg-gray-200 transition"
                                key={item.title}>
                                <Link href={`/user/${item.url}`} className="flex items-center space-x-3">
                                <item.icon className={`w-5 h-5 ${item.title==="Logout" ? "text-red-600"
                                    : "text-gray-700" }`} />
                                <p className={`text-base leading-none ${item.title==="Logout"
                                    ? "text-red-600 hover:text-red-800" : "text-gray-700" }`}>
                                    {item.title}
                                </p>
                                </Link>
                            </SidebarMenuItem>
